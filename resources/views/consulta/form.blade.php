<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="num_historia" class="form-label">{{ __('Num Historia') }}</label>
            <input type="text" name="num_historia" class="form-control @error('num_historia') is-invalid @enderror" value="{{ old('num_historia', $consulta?->num_historia) }}" id="num_historia" placeholder="Num Historia">
            {!! $errors->first('num_historia', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="no_consulta" class="form-label">{{ __('No Consulta') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="fecha_cons" class="form-label">{{ __('Fecha Cons') }}</label>
            <input type="text" name="fecha_cons" class="form-control @error('fecha_cons') is-invalid @enderror" value="{{ old('fecha_cons', $consulta?->fecha_cons) }}" id="fecha_cons" placeholder="Fecha Cons">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="motivo" class="form-control @error('motivo') is-invalid @enderror" value="{{ old('motivo', $consulta?->motivo) }}" id="motivo" placeholder="Motivo">
